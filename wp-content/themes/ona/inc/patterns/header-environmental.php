...
return array(
	...
	'content'    => '
			...
			<!-- wp:navigation {"textColor":"background","className":"ona-sm-down-justify-content-center","layout":{"type":"flex","justifyContent":"left","orientation":"horizontal"},"style":{"spacing":{"blockGap":"46px"}}} -->
				<!-- wp:navigation-link {"label":"' . __( 'Home', 'ona' ) . '","url":"#","kind":"custom","isTopLevelLink":false} /-->
				<!-- wp:navigation-link {"label":"' . __( 'News', 'ona' ) . '","url":"#","kind":"custom","isTopLevelLink":false} /-->
				<!-- wp:navigation-submenu {"label":"' . __( 'Pages', 'ona' ) . '","url":"#","kind":"custom","isTopLevelItem":true} -->
				<!-- wp:navigation-link {"label":"' . __( 'About', 'ona' ) . '","url":"#","kind":"custom","isTopLevelLink":false} /-->
				<!-- wp:navigation-link {"label":"' . __( 'Contact', 'ona' ) . '","url":"#","kind":"custom","isTopLevelLink":false} /-->
